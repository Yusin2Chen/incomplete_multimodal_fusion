...
import torch
from maskformer_train_seg import MaskFormer
from dataset.multimodal_quadruplet import MyDataset, MyDatasetEval
from mask2former_infer_seg import Segmentation
...
def train():
    cfg = get_args()
    dataset_train = MyDataset('/workspace/s1s2dsm_patch', use_s1=True, use_s2=True, use_dem=True, use_dnw=True,
                              unlabeled=False, transform=True, crop_size=256, segm_downsampling_rate=4)
    if cfg.ngpus > 1:
    ...
    dataset_eval = MyDatasetEval('/workspace/s1s2dsm_patch', use_s1=True, use_s2=True, use_dem=True, use_dnw=True,
                                 unlabeled=False, transform=True, crop_size=256, segm_downsampling_rate=4)
