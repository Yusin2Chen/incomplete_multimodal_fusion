...
from utils.criterion_ins import SetCriterion, Criterion
from utils.matcher_ins import HungarianMatcher
...
class MaskFormer:
    def __init__(self, cfg):
        ...
        self.contra_loss = HardNegtive_loss()
    ...
    def train_epoch(self, data_loader, epoch):
        ...
        loss_dice_list = []
        loss_mask_list = []
        for i, (rgb, sar, dsm, targets) in enumerate(data_loader):
            ...
            targets = self.prepare_targets(targets, rgb)
    ...
    def prepare_targets(self, targets, images):
        ...
        for targets_per_image in targets:
            ...
            #print(targets_per_image["labels"])
    ...
    def evaluate(self, eval_loder):
        ...
        for (rgb, sar, dsm, targets) in eval_loder:
            ...
            gt_mask = targets[0]['masks'].sum(dim=0).bool().to(torch.int64)
            # print(inpurt_tensor.shape, gt_mask.shape)
    ...
    def semantic_inference(self, mask_cls, mask_pred):
        mask_cls = F.softmax(mask_cls, dim=-1)[..., 1:]  # omit the first class
